...
# <a id="testimonials"></a> 🙌 Some Testimonials:
...
> What sets Anower apart is not only his technical process but also his honesty and integrity. He consistently communicated progress, challenges, and solutions transparently, making him a reliable and trustworthy team member.<br/> - **Josep Martí, Tech Consultant & Advisor | Fractional CTO**
...
🌍 Live link: [vertrical.com](https://vertrical.com)
<br/> ⚙️ Tech Stack Used: Next.js, TailwindCSS, Contentful, Vercel
...
🌍 Live link: [smilifood.com](https://www.smilifood.com/)
<br/> ⚙️ Tech Stack Used: Next.js 13, TailwindCSS, Framer Motion
...
🌍 Live link: [app.wissenlms.com](https://app.wissenlms.com)
<br/> ⚙️ Tech Stack Used: Angular 10, Bootstrap, Java Spring Boot, AWS, Firebase, MongoDB
...
🌍 You can get a glimpse of it here: [AbabilNG Screencast](https://drive.google.com/file/d/13pzSzLvlT2vesN1dj2UBZ7MtX_Tkk2ES/view?usp=sharing)
<br/> ⚙️ Tech Stack Used: Angular 6, PrimeNG, Angular Material, Java Spring Boot, Docker, Oracle, etc.
...
🌍 Live link: [web.beebl.io](https://web.beebl.io)
<br/> ⚙️ Tech Stack Used: React.js, Bootstrap, Java Spring Boot, AWS, Postgres
...
🌍 Live link: [thedefi.network](https://www.thedefi.network)
<br/> ⚙️ Tech Stack Used: Next.js, TailwindCSS, Vercel, Google Analytics, Figma
...
🌍 Live link: [gistapp.co](https://www.gistapp.co/)
<br/> ⚙️ Tech Stack Used: Next.js, TailwindCSS, AWS Amplify, Firebase, etc.
...
🌍 You can get a glimpse of it here: [TechSpecs Screencast](https://drive.google.com/file/d/1m6e7CNoOl58hVw7p5ZG6UjWzt7F9Eqnc/view?usp=share_link)
<br/> ⚙️ Tech Stack Used: Next.js, MongoDB, Algolia, TailwindCSS, Vercel.
...
🌍 Live link: [atechnology-web.netlify.app](https://atechnology-web.netlify.app)
<br/> ⚙️ Tech Stack Used: Vue.js, Vuetify, Netlify, Lottie animations, Figma
...
🌍 Live link: [xpad.netlify.app](http://xpad.netlify.app)
<br/> ⚙️ Tech Stack Used: React.js, TailwindCSS, Figma
...
🌍 You can get a glimpse of it here: [Saturna Screencast](https://drive.google.com/file/d/1KZCKfmIFa-CtG6VcO7UNjfmQ1FGV3pX8/view?usp=sharing)
<br/> ⚙️ Tech Stack Used: React.js, Typescript, TailwindCSS, Figma
...
🌍 Live link: [solidefiapp.netlify.app](https://solidefiapp.netlify.app/)
<br/> ⚙️ Tech Stack Used: React.js, Typescript, TailwindCSS

## Dosh Capital

A Forex platform.

🌍 Live link: [doshcapital.com.au](https://doshcapital.com.au)
<br/> ⚙️ Tech Stack Used: React.js, Typescript, MUI

## Codashboard

A static dashboard built with Angular.

🌍 Live link: [codashboard.netlify.app](https://codashboard.netlify.app/my-claims)
<br/> ⚙️ Tech Stack Used: Angular
